...
//go:generate go build -v -o=./bin/grapi github.com/lehajam/grapi/cmd/grapi
//go:generate go build -v -o=./bin/grapi-gen-command github.com/lehajam/grapi/cmd/grapi-gen-command
//go:generate go build -v -o=./bin/grapi-gen-scaffold-service github.com/lehajam/grapi/cmd/grapi-gen-scaffold-service
//go:generate go build -v -o=./bin/grapi-gen-service github.com/lehajam/grapi/cmd/grapi-gen-service
//go:generate go build -v -o=./bin/grapi-gen-type github.com/lehajam/grapi/cmd/grapi-gen-type
